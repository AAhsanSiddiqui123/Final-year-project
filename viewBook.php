...
<div class="second_header">
    <!-- <a href="Librarian.php" class="second_headerAn">Home</a> -->
...
// background-color: transparent;
    ...
    <a href="addBook.php" class="second_headerAn">Add books</a>
    <a href="view_issued_book.php" class="second_headerAn">Issued Books</a>
    ...
    $result = mysqli_query($conn, $sql);
	              while($row = mysqli_fetch_array($result))
                  {
                    ...
                    echo "<td class='table_td'>"; 
                        ...
                        echo "<a class='table_btn' id='table_btnDelete' href='delete_book.php?isbn=$isbn' >Delete</a>";  
                    echo "</td>";
