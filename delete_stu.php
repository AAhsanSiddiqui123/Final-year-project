...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['confirm'])){
    ...
    $sql = "DELETE FROM `student` WHERE roll_no=$stu_roll";
...
<h2 class="mid_middle-headerH2">Delete Student</h2>
</div>
...
<div class="inner_form-div">
    ...
    <input type="text" class="form_input" name="delete" value="<?php echo $stu_roll ?>">
</div>
