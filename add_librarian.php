...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['confirm'])){
    ...
    if($_Name!="" && $_email!="" && $_phoneNo!="" && $_address!="" &&  $_password!="" && $_cPassword!=""){
            ...
            if ($result){
                header("Location: view_librarian.php");
            }else{
                $conrirm = "Fail To add ";
            }

            } else{
                $conrirm = "password dones not match";
            }
    }else{
...
<h2 class="mid_middle-headerH2">Add Librarian</h2>
</div>
...
<div class="inner_form-div">
    ...
    <input type="password" class="form_input" name="confirmPassword">
</div>
