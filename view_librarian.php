...
// background-color: transparent;
    ...
    <a href="add_librarian.php" class="second_headerAn">Add librarian</a>
...
<tr>
    ...
    $result = mysqli_query($conn, $sql);
	              while($row = mysqli_fetch_array($result))
                  {
                    ...
                    $lib_phone=$row["lib_phone"];
                    echo "<td class='table_td'>"; echo $row["lib_name"];  echo "</td>";
                    echo "<td class='table_td'>"; echo $row["lib_email"];  echo "</td>";
                    echo "<td class='table_td'>"; echo $row["lib_phone"];  echo "</td>";
                    echo "<td class='table_td'>"; echo $row["lib_address"];  echo "</td>";
                    echo "<td class='table_td'>"; 
                    echo "<a class='table_btn' id='table_btnDelete' href='delete_liabrarian.php?lib_num=$lib_phone' name='delete_btn' >Delete</a>"; 
