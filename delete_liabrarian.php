...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['confirm'])){
    ...
    $sql = "DELETE FROM `librarian` WHERE lib_phone=$lib_phone";
...
<h2 class="mid_middle-headerH2">Delete Librarian</h2>
</div>
...
<div class="inner_form-div">
    ...
    <input type="text" class="form_input" name="delete" value="<?php echo $lib_phone ?>">
</div>
