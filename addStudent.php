...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['confirm'])){
    ...
    $_email = $_POST["email"];
    $_phoneNo = $_POST["phoneNo"];
    $_address = $_POST["address"];
  
    if($_stuName!="" && $_RollNO!="" && $_email!="" && $_phoneNo!="" &&  $_address!="" ){

                $sql = "INSERT INTO `student`(`Studen_name`, `roll_No`, `email`, `phone_No`, `address`) 
                VALUES ('$_stuName','$_RollNO','$_email','$_phoneNo','$_address')";
...
<h2 class="mid_middle-headerH2">Add Student</h2>
</div>
...
<div class="inner_form-div">
    ...
    <input type="text" class="form_input" name="StudentName">
</div>
<div class="inner_form-div">
    <label for="">Roll No</label>
    <input type="text" class="form_input" name="rollNo">
</div>
<div class="inner_form-div">
...
<div class="inner_form-div">
    ...
    <input type="text" class="form_input" name="phoneNo">
</div>
<div class="inner_form-div">
