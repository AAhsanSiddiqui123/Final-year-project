...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save'])){
    ...
    && $_editionpages!="" && $_isbn!="" && $_dept!=""){

            $sql = "INSERT INTO `book`(`book_name`, `generation`, `price`, `author`, `copy_right`, `publisher`, `edition_pages`, `ISBN`, `department`) 
            VALUES ('$_bookname','$_generation','$_price','$_author','$_copyright','$_publisher','$_editionpages','$_isbn','$_dept')";
...
<h2 class="mid_middle-headerH2">Add Books</h2>
</div>
...
<div class="inner_form-div">
    ...
    <input type="text" class="form_input" placeholder="write ISBN " name="isbn">
</div>
<div class="inner_form-div">
<select name="dept" >
